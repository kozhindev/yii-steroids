...
class Notifications extends React.PureComponent {
    ...
    render() {
        const NotificationsView = this.props.view || ui.getView('layout.NotificationsView');
        const NotificationsItemView = this.props.itemView || ui.getView('layout.NotificationsItemView');
